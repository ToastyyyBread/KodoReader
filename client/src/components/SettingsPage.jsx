                ...
                {activeSection === 'changelog' && (
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginTop: 8 }}>
                            {[
                                { date: 'July 2026', version: 'v1.1.3 (Current Release)', features: ['Resolved AI image upscaling corruption and artifacting issues.', 'Dramatically accelerated application startup and library metadata loading times.', 'Enhanced application backup mechanisms for improved reliability.', 'Deprecated and removed Google Drive backup integration in favor of robust local backups.'] },
