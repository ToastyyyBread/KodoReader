                ...
                {activeSection === 'changelog' && (
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginTop: 8 }}>
                            {[
                                { date: 'July 2026', version: 'v1.1.4 (Current Release)', features: ['Reworked Image Compressor to use Sharp for high-efficiency WebP compression.', 'Redesigned Chapter Range selector with Range, Single, and Multiple selection modes.', 'Enhanced AI Upscaler queue cards to display clean series titles, stripping duplicate suffixes.', 'Added direct cancel buttons for individual queued items and cleaned up review states.'] },
                                { date: 'July 2026', version: 'v1.1.3', features: ['Resolved AI image upscaling corruption and artifacting issues.', 'Dramatically accelerated application startup and library metadata loading times.', 'Enhanced application backup mechanisms for improved reliability.', 'Deprecated and removed Google Drive backup integration in favor of robust local backups.'] },
                                { date: 'March 2026', version: 'v1.1.2', features: ['Ported core engine components to Rust for enhanced stability and performance.', 'Optimized AI Upscaler processing logic, resolving the "waiting" state hang bugs.', 'Restructured AI Models architecture to support dynamic, isolated folder installations.', 'Enhanced process lifecycle management to prevent orphaned background tasks.', 'Refined UI navigation with persistent state caching for a smoother experience.'] },
